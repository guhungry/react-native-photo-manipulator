...
const PhotoManipulator: PhotoManipulatorStatic = {
    batch: (image: ImageSource, size: Size, quality: number, operations: Array<PhotoBatchOperations>) => {
    ...
    printText: (image: ImageSource, texts: Array<TextOptions>) => RNPhotoManipulator.printText(image, texts.map(ParamUtils.toTextOptionsNative)),
